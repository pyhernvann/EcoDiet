...
![](../man/figures/eta_mean_without_lit.png){width=700px}

![](../man/figures/PI_mean_without_lit.png){width=700px}
...
![](../man/figures/eta_pouts_without_lit.png){width=550px}

![](../man/figures/PI_pouts_without_lit.png){width=550px}
...
![](../man/figures/PI_pouts_without_lit_details.png){width=550px}
...
![](../man/figures/eta_mean_with_lit.png){width=700px}

![](../man/figures/PI_mean_with_lit.png){width=700px}

```{r, eval = FALSE}
plot_results(mcmc_output, data, pred = "Pout")
```

![](../man/figures/eta_pouts_with_lit.png){width=550px}

![](../man/figures/PI_pouts_with_lit.png){width=550px}
