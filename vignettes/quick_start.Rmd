...
Note that you should put *all* trophic groups as predators, even the groups at the base of your ecosystem. For them you can just put a 0 in each row.
...
data <- preprocess_data(stomach_data_path = example_stomach_data_path, 
                        isotope_data_path = example_isotope_path,
