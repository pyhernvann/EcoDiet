---
title: "How to run the Ecodiet package (quick start)"
author: "Heloise Thero"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{How to run the Ecodiet package (quick start)}
...
This was a test, so we have put a small number of iterations. As you can see from the printed message, it was not enough for the model to converge, so you should now re-run your model with a higher number of iterations:
```{r, eval = FALSE}
