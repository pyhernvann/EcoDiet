...
The literature analysis conducted upstream EcoDiet provides topology and diet matrices that are used to formulate priors
on eta and PI variables. Because the relevance of the literature information is variable, one could be willing to modulate
the precision of the derived priors on eta and PI according the reliability of this information. As just explained, the
reliability of the literature insight is quantified through the Pedigree score.
...
This calculation also involved two parameters allowing to modulate the relationship between the Pedigree value and the priors' precision.
