...
The literature diets matrix is a crucial input to use the model with priors, as it used to set a prior on both the trophic link probabilities ("eta" variable) and the diet proportions ("PI" variable). 
...
* the `literature_slope` parameter.
