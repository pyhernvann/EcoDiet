...
## Define the relative influence of the literature information relative to data

The calculation of the priors for the variables "eta" and "PI" from the literature values and the Pedigree scrore also involves two parameters allowing to modulate the relationship between the Pedigree value and the priors' precision.
