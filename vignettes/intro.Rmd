...
* Default option - Use non informative priors (set by default) - Only stomach content and isotopic data will be used ;
...
* Example of stomach content data:
...
The example correponds to two isotopic data, 13C and 15N. Each line represents one isotope sample, the first column indicates to which group the individual belongs, and the other columns contain the two isotopic measures 13C and 15N.
