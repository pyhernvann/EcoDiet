...
In this vignette, we present and detail the first and default option.
...
The matrix displayed by the `preprocess_data` function is based on the stomach content data: by-default, EcoDiet will investigate trophic links only based on what you have found in stomachs analyses. If you want to add another trophic link, you can modify directly the topological matrix. The by-default topological matrix can be defined by the following instruction : 
