...
You can also plot the probability densities for the one variable (here `PI`) and for one predator:

```{r, fig.height = 4, fig.width = 6, fig.align = "center"}
plot_results(mcmc_output, data, variable = "PI", pred = "huge")
```

You can also precise for which preys you want to plot the probability densities:
