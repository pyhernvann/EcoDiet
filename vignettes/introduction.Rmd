...
You also need to define the trophic discrimination factors corresponding to your isotopic data. In this example, because we have data for the d13C and d15N isotopes, we use the following trophic discrimination factors:
